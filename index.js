    ...
    if (currentName === "move" && character !== "") {
      ...
      if (json[character] === undefined) {
        ...
        Object.keys(json[character]).forEach(function (key) {
          ...
          if (json[character][key]['Motion'] !== undefined && json[character][key]['Motion'] !== null) {
            name = ' / ' + json[character][key]['Motion'];
          }
          // if (json[character][key]['plnCmd'] !== undefined && json[character][key]['plnCmd'] !== null) {
          //   name += ' / ' + json[character][key]['plnCmd'];
          // }
          moves.push(key + name);
        })
...
client.on("ready", () => {
  ...
  client.user.setPresence({
    status: "online",
    activities: [{
      name: 'YOLO? Use /frames or /help to get started.'
    }],
  }); 
});
